 ...
 */
type NoConflict<Key extends string, Base, Handler> = IsAny<Base> extends true ? Handler : Key extends keyof Base ? Conflict<Key> : Handler;
/**
...
//#endregion
export { BaseContext as a, RuntimeName$1 as c, runtimeName as d, seedContext as f, defineMiddleware as i, getEnv as l, Entry as m, Middleware as n, FetchHandler as o, Conflict as p, NoConflict as r, Handler as s, IsAny as t, isContext as u };