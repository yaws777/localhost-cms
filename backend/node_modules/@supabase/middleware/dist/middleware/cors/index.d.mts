...
//#region src/middleware/cors/with-cors.d.ts
/** Decides the `Access-Control-Allow-Origin` value for a request. */
type CorsOrigin = string | string[] | '*' | ((requestOrigin: string | null) => boolean);
 ...
 * ```
 */
declare const withCors: Middleware<'cors', WithCorsConfig, Record<never, never>, CorsContribution>;
//#endregion
export { type CorsContribution, type CorsOrigin, type FetchHandler, type WithCorsConfig, withCors };