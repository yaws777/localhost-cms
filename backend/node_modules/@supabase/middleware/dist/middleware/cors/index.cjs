...
const require_define_middleware = require('../../define-middleware-_GQfpSA-.cjs');
...
* ```
*/
const withCors = require_define_middleware.defineMiddleware({
	key: "cors",
